...
**interest-rate-models**, styled identically to the sister projects
...
4. After the first build (about a minute) the site is served at
   `https://ashjha0.github.io/interest-rate-models/`.
...
- Everything else under `docs/` is reachable by its path, e.g.
  `https://ashjha0.github.io/interest-rate-models/ARCHITECTURE.md` (served raw).
